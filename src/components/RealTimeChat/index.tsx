        ...
        >
          ...
          >
            <FlatList
              ...
              renderItem={({ item }) => <ChatMessage gptIcon={this.props.chatGptIcon} isShowDataTime={this.props.isShowDataTime} receiverStyle={this.props.receivedChatWindow} senderStyle={this.props.senderChatWindow} myId={this.props.clientId || ''} message={item} />}
